...
function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-zinc-800">
      ...
      {/* 1. Form Section: Kept narrow for a sleek, readable input experience */}
      <div className="max-w-2xl mx-auto pt-24 px-6 pb-8">
      ...
      {/* 2. Output Section: Broken out of the max-w-2xl container. Now spans up to max-w-5xl */}
